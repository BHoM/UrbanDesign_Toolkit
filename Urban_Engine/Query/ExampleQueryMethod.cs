...
namespace BH.Engine.Adapters.Urban
{
    public static partial class Query
    {
        ...
        public static string ExampleQueryMethod(this Topography exampleObject, string additionalInput = "")
        {
